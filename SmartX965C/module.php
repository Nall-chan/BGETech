...
/**
 * SmartX965C ist die Klasse für die SmartX965C ModBus Energie-Zähler der Firma B+G E-Tech
 * Erweitert BGETech.
 */
class SmartX965C extends BGETech
{
    public const PREFIX = 'X965C';
    ...
    public static $Variables = [
        ...
        ['Total apparent energy', VARIABLETYPE_FLOAT, 'Electricity', 0x0050, 4, 2, true],
        ['Total energy', VARIABLETYPE_FLOAT, 'Electricity', 0x0052, 4, 2, true],
        ...
        ['Total system reactive power demand', VARIABLETYPE_FLOAT, 'VaR', 0x006C, 4, 2, true],
        ['Maximum total system reactive power demand', VARIABLETYPE_FLOAT, 'VaR', 0x006E, 4, 2, true],
        ['Phase 1 displacement power factor', VARIABLETYPE_FLOAT, '', 0x0070, 4, 2, true],
        ['Phase 2 displacement power factor', VARIABLETYPE_FLOAT, '', 0x0072, 4, 2, true],
        ['Phase 3 displacement power factor', VARIABLETYPE_FLOAT, '', 0x0074, 4, 2, true],
        ['Total displacement power factor', VARIABLETYPE_FLOAT, '', 0x0076, 4, 2, true],
